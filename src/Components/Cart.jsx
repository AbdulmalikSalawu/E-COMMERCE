...
const Cart = () => {
  const { getTotalAmount, productData, cartItems, removeFromCart } =
  ...
  const paywithpaystack = () => {
    ...
    if (localStorage.getItem("token")) {
      axios
        .post(`https://abdulmalikyinka.onrender.com/paywithpaystack`, {
          totalCost,
          email,
        })
        .then((res) => {
      ...
      <div className="cartPage cart-container">
        ...
        <div className="cartitems-down">
          <div className="cartitems-total">
            ...
            <button onClick={paywithpaystack} className="checkout mt-4">
              Pay with paystack
            </button>
            ...
            <div className="cartitems-total">
              ...
              <PayPalScriptProvider
                options={{
                  "client-id":
                    "AQKQkWTppdFkGwobtEgj5PDeeUETPCqL30PcFloGBqoCH2jbmZp9JffWacP2jGbcRGDsjOh7MeZbP3sm",
                }}
              >
                <PayPalButtons
                  className="mt-4"
                  ...
                  createOrder={(data, actions) => {
                    return actions.order.create({
                      purchase_units: [
                        {
                          amount: {
                            value: getTotalAmount().toString(), // Total amount as string
                          },
                        },
                      ],
                    });
